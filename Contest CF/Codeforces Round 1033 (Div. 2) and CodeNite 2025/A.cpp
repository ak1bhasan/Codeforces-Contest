...
void solve()
{
    ...
    if( l1 == l2 && l2 == l3 && b1 + b2 + b3 == l1 ) Found = 1;
    else if( b1 == b2 && b2 == b3 && l1 + l2 + l3 == b1 ) Found = 1;
    else if( l2 == l3 && b1 == b2 + b3 && b1 == l1 + l2 ) Found = 1;
    else if( b2 == b3 && l1 == l2 + l3 && l1 == b1 + b2 ) Found = 1;
